...
class Lable(Widget):
	...
	def __init__(self,textstring,pos=Vec2(0,0),point=16,color=None):
		""" create a gui lable """
...
class Text(Lable):
	...
	def __init__(self,textstring,pos=Vec2(0,0),wrap=5,point=16):
		""" create a gui lable """
...
class BaseInput(Lable):
	...
	def __init__(self,textstring,pos=Vec2(0,0),size=Vec2(100,20),point=16):
		""" create a gui input """
		Lable.__init__(self,textstring,pos)
		self.size = Vec2(size)
...
class Button(Lable):
	...
	def __init__(self,textstring,pos=Vec2(0,0),size=Vec2(100,16),point=16,onClick=None):
		""" create a gui input """
...
class Radio(Button):
	...
	skinType = "RADIOOFF"
	value = False
	def __init__(self,textstring,pos=Vec2(0,0),size=Vec2(20,20),point=16,onClick=None):
...
class Icon(Button):
	...
	def __init__(self,pos=Vec2(0,0),size=Vec2(20,20),point=16,onClick=None):
...
class RealIcon(Button):
	...
	def __init__(self,iconFile,iconRec,pos=Vec2(0,0),size=None,point=16,onClick=None,):
		""" creates a clikcable icon object """
		Button.__init__(self,"",pos,size,point,onClick)
